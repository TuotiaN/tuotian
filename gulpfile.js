...
gulp.task("copy-index",function(){
	gulp.src("*.html").pipe(gulp.dest("D:/phpStudy/WWW/web/tuotian"));//此处路径可以使用/或\\
...
gulp.task("copy-css",function(){
	gulp.src("css/*.css")
		.pipe(gulp.dest("D:/phpStudy/WWW/web/tuotian/css"));
});
//复制js文件架下所有文件
gulp.task("copy-js",function(){
	gulp.src("js/*.js")
		.pipe(gulp.dest("D:/phpStudy/WWW/web/tuotian/js"));
});
//复制img文件架下所有图片
gulp.task("copy-img",function(){
	gulp.src("img/**/*")
		.pipe(gulp.dest("D:/phpStudy/WWW/web/tuotian/img"));
});
//复制video文件架下所有视频
gulp.task("copy-video",function(){
	gulp.src("video/**/*")
		.pipe(gulp.dest("D:/phpStudy/WWW/web/tuotian/video"));
});
